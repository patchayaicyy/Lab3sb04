...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // chain private valible between id component
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //OHM EDIT DEPRECATE MenuItemCompat.setShowAsAction(locationItem, MenuItem.SHOW_AS_ACTION_IF_ROOM);
    ...
    public void buFindBMIEvent(View view) {
        String hight = h.getText().toString();
        String weight = w.getText().toString();

        int hightv = Integer.parseInt(hight);
        int weightv = Integer.parseInt(weight);

        float bmi = weightv/(hightv*hightv);
